...
public class WelcomeActivity extends AppCompatActivity{
    ...
    Button bSkip,bGot,bNext;

    private int[] items_layout = new int[]{R.layout.into_slide_1, R.layout.into_slide_2, R.layout.into_slide_3, R.layout.into_slide_4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!MyPreference.shouldShowSlider()) {
            launchHomeScreen();
            finish();
        }
        ...
        bGot = findViewById(R.id.btn_got_it);
        bNext = findViewById(R.id.btn_next);

        bGot.setOnClickListener(new View.OnClickListener() {
            @Override
...
//    }
    ...
    private void launchHomeScreen() {
        MyPreference.saveFirstTimeLaunch(false);
        startActivity(new Intent(WelcomeActivity.this, MainActivity.class));
        finish();
    }

    private void addBottomDots() {
        if ((dotsLayout == null) || (items_layout == null))
            return;

        int dotSize = items_layout.length;
    ...
    ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            boolean isLastPage = (position == (items_layout.length - 1));
...
//    }
    ...
    private void showNextSlide() {
        ...
        if ((viewPager != null) && (nextIndex < items_layout.length)) {
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = layoutInflater.inflate(items_layout[position], container, false);
        ...
        @Override
        public int getCount() {
            return (items_layout != null) ? items_layout.length : 0;
        }
